...
function Book(title, author, pages, artwork, read) {
...
const render = (newBook) => {
  ...
  artwork.setAttribute('src', newBook.artwork);
  td0.appendChild(artwork);
...
newBookForm.addEventListener('submit', (event) => {
  ...
  const artwork = newBookForm.artWork.value;
  ...
  const newBook = new Book(title, author, pages, artwork, read);
